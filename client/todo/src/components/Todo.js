...
export default class Todo extends Component {
    ...
    style=()=>{const {complete}=this.props.todo
    
    return {textDecoration:complete?"line-through":"none"
      
}
}
    toogle=(id,dispatch)=>{dispatch({type:"TOGGLE",payload:id})}
    remove=(id,dispatch)=>{
    ...
    render() {
        ...
        <input type="checkbox" className="m-2 float-right" onChange={this.toogle.bind(this,_id,dispatch)}/>
    </h3> 
            }}
